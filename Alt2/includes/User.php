...
class User {
	...
	var $mId, $mName, $mRealName, $mPassword, $mNewpassword, $mNewpassTime, 
		...
		$mEmailToken, $mEmailTokenExpires, $mRegistration, $mGroups, $mCity;
	...
	function loadFromDatabase() {
		...
		$s2 = $dbr->selectRow( 'page', 'page_title', array( 'page_id' => $s->user_city ), __METHOD__ );	
			$this->mCity = $s2->page_title;
	...
	// Chris Russo adding these functions
	function setCity(){
